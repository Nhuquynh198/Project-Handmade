        ...
        <div class="container-fluid">
          ...
          <ul class="nav navbar-nav">
            ...
            <!--<li><a href="#">TIN TỨC</a></li>-->
             <li class="dropdown">
              <a href="<?=site_url('tintuc/index')?>" class="dropdown-toggle" data-toggle="dropdown">TIN TỨC <b class="caret"></b></a>
              <ul class="dropdown-menu">
                <li><a href="<?=site_url('tintuc/index')?>">Tin hot trong tuần</a></li>
...
<section class="awe-section-1">
                ...
                <div class="carousel-inner">
                  <div class="item active">
                    <a href="#" class="clearfix">
                    	<img src="<?=base_url('images-q/slide1.png')?>" width="573" height="502" alt="Sile 1" style="width:100%;">
                    </a>
                  </div>
            
                  <div class="item">
                     <a href="#" class="clearfix">
                     	<img src="<?=base_url('images-q/slide2.png')?>" width="573" height="502" alt="Slide 2" style="width:100%;">
                     </a>
                  </div>
                
                  <div class="item">
                     <a href="#" class="clearfix">
                     	<img src="<?=base_url('images-q/slide3.png')?>" width="573" height="502" alt="Slide 3" style="width:100%;">
                     </a>
                  </div>
           		</div>
    ...
    <!-- Left and right controls -->
    	...
    	<div class="col-lg-6 col-md-6">
        	<a href="#" class="clearfix">
            	<img src="<?=base_url('images-q/9.png')?>" width="580" height="220"title="Kiều Thị Như Quỳnh">
            </a>
            
            <div class="col-lg-6 col-md-6" style="padding-top:13px; padding-left:1px" >
            	<a href="#" class="clearfix" title="Kiều Thị Như Quỳnh">
            		
					<img src="<?=base_url('images-q/80.png')?>" width="270" height="240">
            	</a>
                
            </div>
            <div class="col-lg-6 col-md-6" style="padding-top:13px; padding-left:40px">
            	<a href="#" class="clearfix" title="Kiều Thị Như Quỳnh">
            		<img src="<?=base_url('images-q/120.png')?>" width="270" height="240">
            	</a>
                		...
                		<div class="panel-body">                  	
                            ...
                            <?php foreach($bang_phan_loai as $phan_loai) {?>
                              <li class="list-group-item ">
                                <span class="badge"><?=$phan_loai->so_luong_sp_da_phan_loai ;?></span></span>
                               <a href="<?=site_url('sanpham/phanloai/'.$phan_loai->MCL)?>"><?=$phan_loai->ten_ma_loai_san_pham ;?></a>
                              </li>
                           <?php }?>
                            </ul>
                  		</div>
